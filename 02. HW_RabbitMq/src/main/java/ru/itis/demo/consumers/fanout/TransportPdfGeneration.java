...
//consumer для генерации заявления на получение транспортных средств
@Component
public class TransportPdfGeneration extends Consumer {
        ...
        try {
            ...
            channel.basicConsume(queue, false, (consumerTag, message) -> {
                try {
                    ...
                    pdfDocumentsFactory.createTransportPdf(socialUserDto);
                    System.out.println("Заявление на получение помощи в транспортном средстве сформировано");
