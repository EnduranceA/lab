...
@Component
public class ConsentPdfGeneration extends Consumer {
        ...
        try {
            ...
            channel.basicConsume(queue, false, (consumerTag, message) -> {
                try {
                    ...
                    pdfDocumentsFactory.createConsentPdf(grantUserDto);
                    System.out.println("Согласие на обработку данных сформировано");
