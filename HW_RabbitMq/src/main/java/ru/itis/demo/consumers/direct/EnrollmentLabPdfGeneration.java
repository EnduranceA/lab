...
//consumer для получения заявления на зачисление в лабораборию
@Component
public class EnrollmentLabPdfGeneration extends Consumer {
        ...
        try {
            ...
            channel.basicConsume(queue, false, (consumerTag, message) -> {
                try {
                    ...
                    pdfDocumentsFactory.createEnrollmentLabPdf(labUserDto);
                    System.out.println("Заявление на зачисление в лабораторию сформировано");
