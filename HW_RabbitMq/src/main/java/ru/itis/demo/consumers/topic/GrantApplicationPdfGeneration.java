...
@Component
public class GrantApplicationPdfGeneration extends Consumer {
        ...
        try {
            ...
            channel.basicConsume(queue, false, (consumerTag, message) -> {
                try {
                    ...
                    pdfDocumentsFactory.createGrantApplicationPdf(grantUserDto);
                    System.out.println("Заявление для гранта сформировано");
